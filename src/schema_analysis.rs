                        ...
                        if let Some(title_value) = property.get("title") {
                            if let Some(title) = title_value.as_str() {
                                let title_to_use = match self.title_tactic.as_str() {
                                    "_slug" => {slugify(title).replace("-", "_")},
                                    "-slug" => {slugify(title)},
                                    _ => {title.to_owned()}
                                };
                                self.field_titles_map.insert(field_path.clone(), title_to_use);
                            }
                        }
                    }
                }
...
pub fn schema_analysis(schema_path: &str, path_separator: &str, title_tactic: String) -> Result<SchemaAnalysis>{
...
mod tests {
    ...
    fn test_schema_titles() {
        let expected: HashMap<String, String> = HashMap::from([
          ("prop1".to_string(), "sub property title in base.json".to_string()),
          ("prop2".to_string(), "sub property title in base.json".to_string()),
          ("prop3_prop1".to_string(), "sub property title in other.json".to_string()),
          ("prop3_prop2".to_string(), "sub property title in other.json".to_string()),
          ("prop4".to_string(), "sub property title in other.json".to_string()),
          ("prop5".to_string(), "sub property title in other.json".to_string()),
        ]);
    ...
    fn test_slug() {
        let expected: HashMap<String, String> = HashMap::from([
          ("prop1".to_string(), "sub_property_title_in_base_json".to_string()),
          ("prop2".to_string(), "sub_property_title_in_base_json".to_string()),
          ("prop3_prop1".to_string(), "sub_property_title_in_other_json".to_string()),
          ("prop3_prop2".to_string(), "sub_property_title_in_other_json".to_string()),
          ("prop4".to_string(), "sub_property_title_in_other_json".to_string()),
          ("prop5".to_string(), "sub_property_title_in_other_json".to_string()),
        ]);
